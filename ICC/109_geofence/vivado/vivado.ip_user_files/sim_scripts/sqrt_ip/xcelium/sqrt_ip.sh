...
#
# Script generated by Vivado on Mon Feb 19 10:53:45 +0800 2024
...
#
# Usage        : sqrt_ip.sh
#                sqrt_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sqrt_ip.sh [-reset_run]
#                sqrt_ip.sh [-reset_log]
#                sqrt_ip.sh [-help]
#
...
#                script (type 'sqrt_ip.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname axi_utils_v2_0_7 -libname cordic_v6_0_20 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 axi_utils_v2_0_7 cordic_v6_0_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sqrt_ip.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sqrt_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sqrt_ip
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sqrt_ip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sqrt_ip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: sqrt_ip.sh [-step]\n\
Usage: sqrt_ip.sh [-lib_map_path]\n\
Usage: sqrt_ip.sh [-reset_run]\n\
Usage: sqrt_ip.sh [-reset_log]\n\
Usage: sqrt_ip.sh [-keep_index]\n\
